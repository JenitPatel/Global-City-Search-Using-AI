...
import tkinter as tk # tkinter for GUI design
import re # regular expression for pattern matching
from tkinter import END
import pandas as pd # pandas for data load
...
l0=tk.Label(text='SEARCH CITY',font=font1) # adding label at top
l0.grid(row=0,column=1)

# world city data loading (https://simplemaps.com/data/world-cities from NASA)
data = 'C:\\Users\\Jenit\\Desktop\\world-cities.csv'
dataset = pd.read_csv(data, encoding='ISO-8859-1')
my_list = dataset.iloc[:,0].tolist() # convert dataframe into list
